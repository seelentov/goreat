...
func NewEntityRepository(topicRepo *TopicRepository, db *gorm.DB) *EntityRepository {
...
func (e EntityRepository) GetByID(id uint) (*entities.DBEntity, error) {
...
func (e EntityRepository) ByQuery(query queries.Query) GetByResult {
...
func (e EntityRepository) Create(topicName string, values map[string]interface{}) (*entities.DBEntity, error) {
...
func (e EntityRepository) UpdateByID(id uint, fTypes map[string]interface{}) error {
...
func (e EntityRepository) DeleteByID(id uint) error {
